...
let pracOrder = randIntFromInterval(1,2);
  // case 1: practice global first
  // case 2: practice local first
...
let colorMapping = randIntFromInterval(1,2);
  // case 1: global = Red, local = Blue
  // case 2: global = Blue, local = Red

// instrction variables based on mappings
let finger_S = (taskMapping == 1) ? "left" : "right";
let finger_H = (taskMapping == 1) ? "right" : "left";
let key_S = (taskMapping == 1) ? "1" : "0";
let key_H = (taskMapping == 1) ? "0" : "1";
let globalColor = (colorMapping == 1) ? "red" : "blue";
let localColor = (colorMapping == 1) ? "blue" : "red";
...
$(document).ready(function(){
  ...
  $("body").keypress(function(event){
    if (expType == 0) {
      ...
      acc = (actionSet[trialCount] == partResp) ? 1 : 0;
      if (acc == 1){accCount++;}
